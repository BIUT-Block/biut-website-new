...
cardErrorTxt = 'The format of the id card number is incorrect.'
imgError1 = 'Please upload the front of your id card.'
imgError2 = 'Please upload the reverse side of your id card.'
imgError3 = 'Please upload the correct image type.'
imgError4 = 'The size of the uploaded image should not be larger than 4M.'
imgError5 = 'Selected picture'
imgError6 = 'No image selected ...'
...
$(function () {
  ...
  if (langS == "zh") {
    cardErrorTxt = '身份证号码格式不正确'
    imgError1 = '请上传身份证正面'
    imgError2 = '请上传身份证反面'
    imgError3 = '请上传正确的图片类型'
    imgError4 = '上传的图片大小不能大于4M'
    imgError5 = '已选择图片'
    imgError6 = '未选择图片 ...'
  }
  ...
  $("#submitForm").click(function () {
    ...
    if (userName == "") {
      ...
      $("#userCard").addClass("errorBorder")
      $("#cardError").css("display", "block").text(cardErrorTxt)
    } else if (ipt1 == "") {
      alert(imgError1)
    } else if (ipt2 == "") {
      alert(imgError2)
